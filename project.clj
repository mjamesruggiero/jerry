(defproject jerry "0.1.0-SNAPSHOT"
  :description "Toy calculator in React"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "jerry.core/on-figwheel-reload"}

                :compiler {:main jerry.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/jerry.js"
